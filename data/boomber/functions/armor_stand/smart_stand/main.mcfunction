...
execute as @s[tag=boomber.armor_stand.small, tag=boomber.armor_stand.edit.left_arm] rotated ~ 0 anchored eyes positioned ^0.2 ^0.2 ^ run function boomber:armor_stand/smart_stand/part/left_arm
execute as @s[tag=boomber.armor_stand.small, tag=boomber.armor_stand.edit.right_arm] rotated ~ 0 anchored eyes positioned ^-0.2 ^0.2 ^ run function boomber:armor_stand/smart_stand/part/right_arm
execute as @s[tag=boomber.armor_stand.small, tag=boomber.armor_stand.edit.left_leg] rotated ~ 0 anchored eyes positioned ^0.05 ^-0.1 ^ run function boomber:armor_stand/smart_stand/part/left_leg
execute as @s[tag=boomber.armor_stand.small, tag=boomber.armor_stand.edit.right_leg] rotated ~ 0 anchored eyes positioned ^-0.05 ^-0.1 ^ run function boomber:armor_stand/smart_stand/part/right_leg
