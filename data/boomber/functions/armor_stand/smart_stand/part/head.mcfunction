...
execute store result entity @s Pose.Head[0] float 0.00001 run scoreboard players get #bb.ae.orientation.y bb.variable
execute store result entity @s Pose.Head[1] float 0.00001 run scoreboard players get #bb.ae.orientation.x bb.variable