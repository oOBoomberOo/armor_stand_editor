data merge entity @s {Pose: {LeftArm: [0.0f, 90.0f, 0.0f]}}
...
execute store result entity @s Pose.LeftArm[0] float 0.001 run scoreboard players get #bb.ae.ry bb.calc
execute store result entity @s Pose.LeftArm[1] float 1 run data get entity @e[tag=boomber.armor_stand.vector, limit=1] Rotation[0]
