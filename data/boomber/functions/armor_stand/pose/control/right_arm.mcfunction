...
execute store result entity @s Pose.RightArm[0] float 0.0001 run scoreboard players get #bb.ae.ry bb.result
execute store result entity @s Pose.RightArm[1] float 0.0001 run scoreboard players get #bb.ae.rx bb.result
