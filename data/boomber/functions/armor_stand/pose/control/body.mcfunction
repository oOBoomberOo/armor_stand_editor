...
execute store result entity @s Pose.Body[0] float 0.0001 run scoreboard players get #bb.ae.ry bb.calc
execute store result entity @s Pose.Body[1] float 0.0001 run scoreboard players get #bb.ae.rx bb.calc
