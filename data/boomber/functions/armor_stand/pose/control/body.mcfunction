data merge entity @s {Pose: {Body: [0.0f, 90.0f, 0.0f]}}
...
execute if score #bb.ae.alt_control bb.variable = #bb.ae.bool.true bb.enum if score #bb.ae.ry bb.calc matches -100000..100000 run function boomber:armor_stand/pose/control/snap/body
...
execute store result entity @s Pose.Body[0] float 0.0001 run scoreboard players get #bb.ae.ry bb.result
execute store result entity @s Pose.Body[1] float 0.0001 run scoreboard players get #bb.ae.rx bb.result
