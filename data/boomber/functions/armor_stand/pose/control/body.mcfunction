...
execute if score alt_control bb.ae.var = #bool.true bb.ae.enum if score ry bb.ae.calc matches -100000..100000 run function boomber:armor_stand/pose/control/snap/body
...
execute store result entity @s Pose.Body[0] float 0.0001 run scoreboard players get ry bb.ae.result
execute store result entity @s Pose.Body[1] float 0.0001 run scoreboard players get rx bb.ae.result
