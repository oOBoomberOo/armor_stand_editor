data merge entity @s {Pose: {LeftLeg: [0.0f, 90.0f, 0.0f]}}
...
execute store result entity @s Pose.LeftLeg[0] float 0.0001 run scoreboard players get #bb.ae.ry bb.result
execute store result entity @s Pose.LeftLeg[1] float 0.0001 run scoreboard players get #bb.ae.rx bb.result
