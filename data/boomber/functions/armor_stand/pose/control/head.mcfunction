...
execute store result entity @s Pose.Head[0] float 0.0001 run scoreboard players get ry bb.ae.result
execute store result entity @s Pose.Head[1] float 0.0001 run scoreboard players get rx bb.ae.result
