...
execute positioned ^-0.3 ^1.4 ^ run function boomber:armor_stand/selector/query/right_arm
execute positioned ^0.3 ^1.4 ^ run function boomber:armor_stand/selector/query/left_arm
