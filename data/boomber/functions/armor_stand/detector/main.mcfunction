...
execute as @a[tag=boomber.armor_stand.target] at @s anchored eyes positioned ^ ^-0.1 ^0.5 as @e[tag=boomber.armor_stand.detector, limit=1, sort=nearest] run function boomber:armor_stand/detector/teleport
