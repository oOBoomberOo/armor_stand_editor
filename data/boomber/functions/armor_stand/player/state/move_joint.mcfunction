...
execute unless data entity @s SelectedItem.tag{ctc: {id: 'editor_wand', from: 'boomber:armor_stand'}} run function boomber:armor_stand/player/state/move_joint/cancel
